...
public class JSONObject {
	...
	// 				list.Add(new JSONObject(entry.Value));
	// 				Debug.Log("NULL");
	// 				break;
	// 		}
	// 	}
	...
	public void SetField(int id, string val)     { SetField(id.ToString(), val); }
	public void SetField(int id, bool val)       { SetField(id.ToString(), val); }
	public void SetField(int id, float val)      { SetField(id.ToString(), val); }
	public void SetField(int id, int val)        { SetField(id.ToString(), val); }
	public void SetField(int id, JSONObject obj) { SetField(id.ToString(), obj); }
	...
	public void InitField(int id, string val)     { InitField(id.ToString(), val); }
	public void InitField(int id, bool val)       { InitField(id.ToString(), val); }
	public void InitField(int id, float val)      { InitField(id.ToString(), val); }
	public void InitField(int id, int val)        { InitField(id.ToString(), val); }
	public void InitField(int id, JSONObject obj) { InitField(id.ToString(), obj); }

	public void InitField(string name, string val)     { InitField(name, CreateStringObject(val)); }
	public void InitField(string name, bool val)       { InitField(name, Create(val)); }
	public void InitField(string name, float val)      { InitField(name, Create(val)); }
	public void InitField(string name, int val)        { InitField(name, Create(val)); }
	public void InitField(string name, JSONObject obj) {
		if(!HasField(name)) {
			AddField(name, obj);
		}
	}
	...
	public JSONObject GetField(int id) {
