...
// Simple Proxies
  ...
  static public void Trigger(this GameObject that, string eventName, UData payload)
  {
    that.WithComponent<UkuleleController>().Trigger(eventName, payload);
  }
  static public void Trigger(this Component that, string eventName, UData payload)
  {
    that.WithComponent<UkuleleController>().Trigger(eventName, payload);
  }

  static public void Trigger(this GameObject that, UData eventData)
  {
    that.WithComponent<UkuleleController>().Trigger(eventData);
  }
  static public void Trigger(this Component that, UData eventData)
  {
    that.WithComponent<UkuleleController>().Trigger(eventData);
  }
  ...
  static public void Emit(this GameObject that, string eventName, UData payload)
  {
    that.WithComponent<UkuleleController>().Emit(eventName, payload);
  }
  static public void Emit(this Component that, string eventName, UData payload)
  {
    that.WithComponent<UkuleleController>().Emit(eventName, payload);
  }

  static public void Emit(this GameObject that, UData eventData)
  {
    that.WithComponent<UkuleleController>().Emit(eventData);
  }
  static public void Emit(this Component that, UData eventData)
  {
    that.WithComponent<UkuleleController>().Emit(eventData);
  }
