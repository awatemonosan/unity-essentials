...
namespace Ukulele
{
    ...
    // Config
        ...
        public float baseTorque           =  100.0f; // the base power of the engine (per wheel, and before gears)
...
// Helper Methods
        ...
        private float GetCurrentMotorizedWheelsRPM ()
        {
            ...
            foreach (WheelController wheelController in this.GetComponentsInChildren<WheelController>()) {
