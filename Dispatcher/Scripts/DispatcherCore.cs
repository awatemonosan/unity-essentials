...
public class DispatcherCore : MonoBehaviour {
  ...
  void Awake() {Broadcast.Trigger("Awake");}
  void FixedUpdate() {Broadcast.Trigger("FixedUpdate");}
  void LateUpdate() {Broadcast.Trigger("LateUpdate");}
  void OnConnectedToServer() {Broadcast.Trigger("OnConnectedToServer");}
  void OnDestroy() {Broadcast.Trigger("OnDestroy");}
  void OnDisconnectedFromServer() {Broadcast.Trigger("OnDisconnectedFromServer");}
  void OnFailedToConnect() {Broadcast.Trigger("OnFailedToConnect");}
  void OnFailedToConnectToMasterServer() {Broadcast.Trigger("OnFailedToConnectToMasterServer");}
  void OnPlayerConnected() {Broadcast.Trigger("OnPlayerConnected");}
  void OnPlayerDisconnected() {Broadcast.Trigger("OnPlayerDisconnected");}
  void OnPostRender() {Broadcast.Trigger("OnPostRender");}
  void OnPreCull() {Broadcast.Trigger("OnPreCull");}
  void OnPreRender() {Broadcast.Trigger("OnPreRender");}
  void OnRenderObject() {Broadcast.Trigger("OnRenderObject");}
  void OnServerInitialized() {Broadcast.Trigger("OnServerInitialized");}
  ...
  void OnGUI() {
    ...
    Broadcast.Trigger("OnGUI");
    do {
      Broadcast.Trigger("OnGUI"+e.type);
